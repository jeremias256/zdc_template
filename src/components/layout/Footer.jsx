...
export const Footer = () => {
	return (
		<footer className='bg-text px-2 py-4 desktop:px-0'>
			<div className='max-w-[1280px] flex justify-center mx-auto flex-col w-full'>
				...
				<div className='h-[1px] my-4 bg-white w-full'></div>
				<div className='font-inter text-white mx-auto'>@2024 ST</div>
